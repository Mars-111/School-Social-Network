...
//            if (subject == null) {
//                log.warn("User {} is not authorized to subscribe to {}", subject, destination);
//                return null;
//            }
//
...
//                }
//            }
//            else if (destination.startsWith("/user/") || destination.startsWith("/system/")) {
//                if (subject.equals(destination.split("/")[2])) {
//                    return message;
//                }
//                else {
//                    return null;
